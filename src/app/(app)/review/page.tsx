...
export default async function ReviewPage({
  ...
  return (
    <div className="space-y-5">
      <header className="space-y-3 relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/20 via-primary/6 to-transparent px-4 py-5 shadow-[0_12px_36px_-20px_var(--primary)] backdrop-blur-xl">
