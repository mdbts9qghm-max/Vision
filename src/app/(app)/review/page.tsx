...
export default async function ReviewPage({
  ...
  return (
    <div className="space-y-5">
      <header className="space-y-3 relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/20 via-card to-card px-4 py-5 shadow-[0_10px_36px_-18px_var(--primary)]">
