...
export default async function ReviewPage({
  ...
  return (
    <div className="space-y-5">
      <header className="space-y-3 relative overflow-hidden rounded-2xl border border-white/15 bg-gradient-to-br from-primary/45 via-primary/15 to-transparent px-4 py-5 shadow-[0_14px_40px_-18px_oklch(0.55_0.23_262_/_0.85)] backdrop-blur-xl">
